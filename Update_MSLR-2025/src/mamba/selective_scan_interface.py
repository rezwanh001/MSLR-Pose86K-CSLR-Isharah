...
class MambaInnerFnNoOutProj(torch.autograd.Function):
    ...
    def forward(ctx, xz, conv1d_weight, conv1d_bias, x_proj_weight, delta_proj_weight,
        ...
        conv1d_out = causal_conv1d_cuda.causal_conv1d_fwd(
            x,                # arg0: torch.Tensor
            conv1d_weight,    # arg1: torch.Tensor
            conv1d_bias,      # arg2: Optional[torch.Tensor]
            None,             # arg3: Optional[torch.Tensor]
            None,             # arg4: Optional[torch.Tensor]
            None,             # arg5: Optional[torch.Tensor]
            True              # arg6: bool
        )
    ...
    def backward(ctx, dout):
        ...
        dx, dconv1d_weight, dconv1d_bias, *_ = causal_conv1d_cuda.causal_conv1d_bwd(
            ...
            conv1d_weight,      # arg1: torch.Tensor
            conv1d_bias,        # arg2: Optional[torch.Tensor]
            dconv1d_out,        # arg3: torch.Tensor
            None,               # arg4: Optional[torch.Tensor]
            None,               # arg5: Optional[torch.Tensor]
            None,               # arg6: Optional[torch.Tensor]
            None,               # arg7: Optional[torch.Tensor]
            True,               # arg8: bool
            False               # arg9: bool
        )
